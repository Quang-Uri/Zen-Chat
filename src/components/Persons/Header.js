                ...
                <div className='flex flex-row items-center z-10'>
                    ...
                    >
                        ...
                        <Link onClick={hidevisible_friends} className="w-full">
                            <Dropdown.Item>
                                <FaUserFriends className="h-6 w-6 mr-2 hover:bg-white hover:text-black hover:rounded-2xl hover:cursor-pointer" />
                                Friends
                            </Dropdown.Item>
                        </Link>
                        ...
                        <Link onClick={handleLogout} className="w-full">
                            <Dropdown.Item>
                                <LuLogOut className="h-6 w-6 mr-2 hover:bg-white hover:text-black hover:rounded-2xl hover:cursor-pointer" />
                                Logout
                            </Dropdown.Item>
                        </Link>
                    </Dropdown>
