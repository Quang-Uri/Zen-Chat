    ...
    return (
        <div className="bg-bgLight2 dark:bg-bgDark1 w-full flex flex-row items-center p-4 justify-center h-screen bgWithImage">
            <div className='bg-bgLight1 dark:bg-bgDark2 relative xs:w-full xs:justify-center md:w-4/6 lg:w-3/4 xl:w-1/3 xs:h-full md:h-5/6 flex flex-col rounded-2xl'>
                <Link to="/login">
                    <SlArrowLeftCircle className="absolute m-4 h-10 w-10 top-1 left-0 text-black hover:bg-loginTextBgLight hover:text-white dark:text-white dark:hover:bg-bgLight2 dark:hover:text-black hover:rounded-2xl hover:cursor-pointer" />
                </Link>
                <div className='p-8 mt-10'>
                    <form onSubmit={handleSubmit} className="flex flex-col w-11/12 m-auto mt-6 gap-4">
                        ...
                        <div className="flex justify-center items-center my-3">
                            <Button color="light" disabled={loading} type="submit">
                                <span className="flex items-center">
                                    <span className="text-sm font-bold">Tạo tài khoản</span>
                                </span>
                            </Button>
                        </div>  
                    </form>
